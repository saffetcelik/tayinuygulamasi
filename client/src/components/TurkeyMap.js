...
function TurkeyMap({ tercihler = [], onIlSelect = null, maxTercih = 3 }) {
    ...
    return (
        <div className="modern-turkey-map-container">
            ...
            {errorMessage && (
                <div className="mt-2 mb-2 flex items-center space-x-2 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-md border-l-4 border-red-500 dark:border-red-400 animate-fade-in">
