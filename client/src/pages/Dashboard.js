...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="relative bg-white shadow-lg border-b border-gray-200/50 overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-slate-800 to-slate-700 py-2 px-4 border-b border-slate-600/30">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-6 w-full md:w-auto">
            ...
            <div className="relative w-full md:w-auto">
              <button
                ...
                className="flex items-center mb-3 md:mb-0 bg-white/95 hover:bg-white backdrop-blur-sm rounded-xl px-4 py-3 transition-all duration-300 shadow-lg hover:shadow-xl w-full md:w-auto justify-between md:justify-start border border-gray-200/50 group"
                ref={profilMenuRef}
              >
                <div className="flex items-center">
                  ...
                  <div className="text-sm">
                    <div className="font-bold text-gray-800">{personelBilgisi.ad} {personelBilgisi.soyad}</div>
                    <div className="text-xs text-gray-600 font-medium">{personelBilgisi.unvan}</div>
                  </div>
                </div>
                <svg className={`w-4 h-4 ml-2 text-gray-500 transition-transform duration-200 ${profilMenuOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {profilMenuOpen && (
                <div
                  className="fixed w-72 bg-white backdrop-blur-sm rounded-xl shadow-2xl overflow-hidden border border-gray-200 animate-fadeIn"
                  style={{
                    zIndex: 99999,
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div
            ref={mobileMenuRef}
            className={`${mobileMenuOpen ? 'block animate-slideInRight' : 'hidden'} md:block w-full md:w-64 bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/50 transition-all duration-500 ease-in-out transform md:transform-none ${mobileMenuOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>

              {/* Modern Header */}
              <div className="relative bg-gradient-to-br from-slate-50 to-gray-100/80 px-6 py-5 border-b border-gray-200/50">
                <div className="absolute inset-0 opacity-5">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-primary-500 rounded-full -translate-y-12 translate-x-12"></div>
                </div>
                <div className="relative flex items-center">
                  <div className="bg-primary-100 p-2 rounded-xl mr-3 border border-primary-200/50">
                ...
                <ul className="space-y-2">
                  <li className="group">
                    <button
                      ...
                      className={`relative flex items-center w-full px-4 py-3 rounded-xl transition-all duration-500 ease-out overflow-hidden ${activeTab === 'profile' ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg' : 'text-gray-700 hover:text-primary-700 hover:shadow-md'}`}
                    >
                      {/* Smooth background transition */}
                      <div className={`absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 transition-all duration-500 ease-out ${activeTab === 'profile' ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}></div>

                      <div className={`relative p-2 rounded-lg mr-3 transition-all duration-500 ease-out ${activeTab === 'profile' ? 'bg-white/20 scale-110' : 'bg-gray-100 group-hover:bg-primary-100 group-hover:scale-105'}`}>
                  ...
                  <li className="group">
                    <button
                      ...
                      className={`relative flex items-center w-full px-4 py-3 rounded-xl transition-all duration-500 ease-out overflow-hidden ${activeTab === 'create' ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg' : 'text-gray-700 hover:text-primary-700 hover:shadow-md'}`}
                    >
                      {/* Smooth background transition */}
                      <div className={`absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 transition-all duration-500 ease-out ${activeTab === 'create' ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}></div>

                      <div className={`relative p-2 rounded-lg mr-3 transition-all duration-500 ease-out ${activeTab === 'create' ? 'bg-white/20 scale-110' : 'bg-gray-100 group-hover:bg-primary-100 group-hover:scale-105'}`}>
                        <svg className="w-4 h-4 transition-transform duration-500 ease-out" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li className="group">
                    <button
                      ...
                      className={`relative flex items-center w-full px-4 py-3 rounded-xl transition-all duration-500 ease-out overflow-hidden ${activeTab === 'list' ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg' : 'text-gray-700 hover:text-primary-700 hover:shadow-md'}`}
                    >
                      {/* Smooth background transition */}
                      <div className={`absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 transition-all duration-500 ease-out ${activeTab === 'list' ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}></div>

                      <div className={`relative p-2 rounded-lg mr-3 transition-all duration-500 ease-out ${activeTab === 'list' ? 'bg-white/20 scale-110' : 'bg-gray-100 group-hover:bg-primary-100 group-hover:scale-105'}`}>
                        <svg className="w-4 h-4 transition-transform duration-500 ease-out" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li className="group">
                    <button
                      ...
                      className={`relative flex items-center w-full px-4 py-3 rounded-xl transition-all duration-500 ease-out overflow-hidden ${activeTab === 'sss' ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg' : 'text-gray-700 hover:text-primary-700 hover:shadow-md'}`}
                    >
                      {/* Smooth background transition */}
                      <div className={`absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 transition-all duration-500 ease-out ${activeTab === 'sss' ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}></div>

                      <div className={`relative p-2 rounded-lg mr-3 transition-all duration-500 ease-out ${activeTab === 'sss' ? 'bg-white/20 scale-110' : 'bg-gray-100 group-hover:bg-primary-100 group-hover:scale-105'}`}>
                        <svg className="w-4 h-4 transition-transform duration-500 ease-out" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li className="group">
                    <button
                      ...
                      className={`relative flex items-center w-full px-4 py-3 rounded-xl transition-all duration-500 ease-out overflow-hidden ${activeTab === 'settings' ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-lg' : 'text-gray-700 hover:text-primary-700 hover:shadow-md'}`}
                    >
                      {/* Smooth background transition */}
                      <div className={`absolute inset-0 bg-gradient-to-r from-gray-50 to-gray-100 transition-all duration-500 ease-out ${activeTab === 'settings' ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}></div>

                      <div className={`relative p-2 rounded-lg mr-3 transition-all duration-500 ease-out ${activeTab === 'settings' ? 'bg-white/20 scale-110' : 'bg-gray-100 group-hover:bg-primary-100 group-hover:scale-105'}`}>
                        <svg className="w-4 h-4 transition-transform duration-500 ease-out" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex-1 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-100">
            {activeTab === 'profile' && (
              <div className="space-y-8">
                ...
                <div className="relative bg-gradient-to-br from-slate-50 to-gray-100/80 rounded-xl shadow-lg border border-gray-200/50 overflow-hidden">
                  ...
                  <div className="relative z-10 px-6 py-5">
                    <div className="flex items-center space-x-4">
                      <div className="relative">
                        <div className="bg-primary-100 p-3 rounded-xl border border-primary-200/50">
                      ...
                      <div className="text-gray-800 flex-1">
                        ...
                        <p className="text-gray-600 text-sm font-medium mb-1">{personelBilgisi.unvan}</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-xl shadow-md border border-gray-200/50 overflow-hidden hover:shadow-lg transition-all duration-300">
                    <div className="bg-gradient-to-r from-slate-50 to-gray-100/50 px-6 py-4 border-b border-gray-200/50">
                      <div className="flex items-center">
                        <div className="bg-primary-100 p-2 rounded-lg mr-3">
                          <svg className="w-5 h-5 text-primary-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                          </svg>
                        </div>
                    ...
                    <div className="p-5 space-y-4">
                      {/* Sicil Numarası */}
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        <div className="bg-primary-100 p-2 rounded-lg mr-3">
                          <svg className="w-4 h-4 text-primary-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                          </svg>
                        </div>
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">Sicil Numarası</p>
                          <p className="text-lg font-semibold text-gray-800">{personelBilgisi.sicilNo}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">Doğum Tarihi</p>
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">İşe Başlama Tarihi</p>
                          <p className="text-lg font-semibold text-gray-800">
                  ...
                  <div className="bg-white rounded-xl shadow-md border border-gray-200/50 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="p-5 space-y-4">
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">Telefon</p>
                          <p className="text-lg font-semibold text-gray-800">{personelBilgisi.telefon}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">E-posta</p>
                          <p className="text-lg font-semibold text-gray-800 break-all">{personelBilgisi.email}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-gray-500 font-medium mb-1">Mevcut Adliye</p>
                          <p className="text-lg font-semibold text-gray-800">{personelBilgisi.mevcutAdliye}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="max-w-7xl mx-auto bg-gradient-to-br from-white via-gray-50/50 to-gray-100/30 rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
                  <div className="relative bg-gradient-to-br from-slate-50 to-gray-100/80 border-b border-gray-200/50 px-8 py-6">
                    ...
                    <div className="relative z-10 flex items-center">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-gray-800 mb-1">Tayin Taleplerim</h2>
                        <p className="text-gray-600 text-sm">Oluşturduğunuz tayin taleplerini görüntüleyin ve yönetin</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto bg-gradient-to-br from-white via-gray-50/50 to-gray-100/30 rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
                  <div className="relative bg-gradient-to-br from-slate-50 to-gray-100/80 border-b border-gray-200/50 px-8 py-6">
                    ...
                    <div className="relative z-10 flex items-center">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-gray-800 mb-1">Sık Sorulan Sorular</h2>
                        <p className="text-gray-600 text-sm">Tayin işlemleri hakkında merak edilen sorular ve cevapları</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto bg-gradient-to-br from-white via-gray-50/50 to-gray-100/30 rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
                  <div className="relative bg-gradient-to-br from-slate-50 to-gray-100/80 border-b border-gray-200/50 px-8 py-6">
                    ...
                    <div className="relative z-10 flex items-center">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-gray-800 mb-1">Ayarlar</h2>
                        <p className="text-gray-600 text-sm">Hesap güvenliğinizi ve tercihlerinizi yönetin</p>
                      </div>
                    </div>
                  </div>
                </div>
